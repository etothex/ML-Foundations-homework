...
def update_w(w,data,sign,halt_last,k=1.0):
    '''
    update w
    :param w: 
    :param data: 
...
def PLA(data,sign,w=list([0,0,0,0,0]),k=1.0):
    '''
    实现PLA算法。
    :param data: 数据
    :param sign: 标记
    ...
    '''
    #生成随机序列，index_random是将data list的索引打乱后的列表，pt是index_random的索引
    index_random=[]
...
if __name__ == '__main__':
    ...
    for i in range(200):
        w = [0,0,0,0,0]
        w,steps,halt_last = PLA(data,sign,w,k=0.5)
